...
function stats=stimhgamAnalysis(AnalysisNum,hem)
...
switch AnalysisNum
    case 1
        ...
        info.Analysis   = [hem '_stimHGP_AbsConcByROI'];
    ...
    case 2
        ...
        info.Analysis   = [hem '_stimHGP_RespAbsConcByROI'];
    ...
    case 3
        ...
        info.Analysis   = [hem '_stimHGP_CorrectAbsConcByROI'];
    ...
    case 4
        ...
        % Correct Absstract vs Concrete
        info.Analysis   = [hem '_stimHGP_CorrectAbsConcRemByROI'];
        info.cond1 	= cellfun(@and,data.conds(subjs,1),data.conds(subjs,3),'uniformoutput',0); % correct abstract
    ...
    case 5
        ...
        %info            =[];
        info.Analysis   = [hem '_stimHGP_testRTcorr'];
        info.groupNames = {'IPS','SPL','AG'};
    ...
    case 6
        ...
        %info            =[];
        info.Analysis   = [hem '_stimHGPcorrectAbsConc_testRTcorr'];
    ...
    case 7
        ...
        %info            =[];
        info.Analysis   = [hem '_stimHGPcorrectAbsConcRem_testRTcorr'];
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
    ...
    case 8
        ...
        % type
        info.Analysis   = [hem '_stimHGPcorrectAbsConc_testRTcorrByCond'];
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend 	= info.groupNames;
    ...
    case 9
        ...
        info.Analysis   = [hem '_stimHGPcorrectAbsConcRem_testRTcorrByCond'];
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
    ...
    case 10
        ...
        info.Analysis   = [hem '_stimHGP_testRTSplitByQuantile'];
        info.groupNames = {'IPS','SPL','AG'};
        info.savePath   = '/Users/alexandergonzalez/Google Drive/Research/ECoG_SS2e/Results/Plots/';
        info.legend     = 1;
        ...
        for iROI = 1:3
            ...
            info.colID          = iROI;
            info.shade_toi      = 1;
            info.toi            = [0.6 0.7]; % time of interest in seconds for bar plot
            parametricTimeCoursePlot(Z,t,info)
    ...
    case 11
        ...
        info.Analysis   = [hem '_stimHGPcorrectAbsConcRem_studyRTcorrByCond'];
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
    ...
    case 12
        ...
        %info            =[];
        info.Analysis   = [hem '_stimHGPcorrectAbsConcRem_encRTcorr'];
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
    ...
    case 13
        ...
        info.Analysis   = [hem '_stimHGP_CorrectAllByROI'];
        info.cond1 	= cellfun(@and,data.conds(subjs,1),data.conds(subjs,3),'uniformoutput',0); % correct abstract
        info.cond1 	= cellfun(@and,info.cond1,data.conds(subjs,5),'uniformoutput',0); % correctly remembered
        info.cond2 	= cellfun(@and,data.conds(subjs,2),data.conds(subjs,4),'uniformoutput',0); % correct concrete
    ...
    case 14
        ...
        info.Analysis   = [hem '_stimHGPenc_stimHGPret'];
        info.cond1  = cellfun(@and,data.conds(subjs,1),data.conds(subjs,3),'uniformoutput',0); % correct abstract
        info.cond1  = cellfun(@and,info.cond1,data.conds(subjs,5),'uniformoutput',0); % correctly remembered
        info.cond2  = cellfun(@and,data.conds(subjs,2),data.conds(subjs,4),'uniformoutput',0); % correct concrete
        info.cond2  = cellfun(@and,info.cond2,data.conds(subjs,5),'uniformoutput',0); % correct remembered
