...
function stats=stimThetaAnalysis(AnalysisNum)

addpath Analysis/
addpath lib/

dirPath         = '/Volumes/ECoG_SS2/SS2/SS2e/Results/';
fileName        = 'allERSPsthetaGroupstimLocksublogPowernonLPCCh';
...
switch AnalysisNum
    case 1
        ...
        info.Analysis   = 'stimTHP_AbsConcByROI';
    ...
    case 2
        ...
        info.Analysis   = 'stimTHP_RespAbsConcByROI';
    ...
    case 3
        ...
        info.Analysis   = 'stimTHP_CorrectAbsConcByROI';
    ...
    case 4
        ...
        info.Analysis   = 'stimTHP_CorrectAbsConcRemByROI';
        info.cond1 	= cellfun(@and,data.conds(:,1),data.conds(:,3),'uniformoutput',0); % correct abstract
...
% activity set 2: correlation to test RTs activity                      
    case 5
        % overall correlation
        %info            =[];
        info.Analysis   = 'stimTHP_testRTcorr';
        info.groupNames = {'IPS','SPL','AG'};
    ...
    case 6
        ...
        %info            =[];
        info.Analysis   = 'stimTHPcorrectAbsConc_testRTcorr';
    ...
    case 7 
        ...
        info.Analysis   = 'stimTHPcorrectAbsConcRem_testRTcorr';        
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
    ...
    case 8
        ...
        % type
        info.Analysis   = 'stimTHPcorrectAbsConc_testRTcorrByCond';
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend 	= info.groupNames;
    ...
    case 9
        ...
        info.Analysis   = 'stimTHPcorrectAbsConcRem_testRTcorrByCond';
        info.groupNames = {'IPS','SPL','AG'};
        %info.legend    = info.groupNames;
